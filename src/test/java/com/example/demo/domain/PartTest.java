...
class PartTest {
    ...
    /*
     * PART J TESTS
     * Add at least two unit test for Min and Max inventory
    */

    @Test
    void getMin() {
        int min=1;
        partIn.setMIN_INV(min);
        assertEquals(min,partIn.getMIN_INV());
        partOut.setMIN_INV(min);
        assertEquals(min,partOut.getMIN_INV());
    }
    @Test
    void setMin() {
        int min=1;
    ...
    void getMax() {
        int max=10;
        partIn.setMAX_INV(max);
        assertEquals(max,partIn.getMAX_INV());
        partOut.setMAX_INV(max);
        assertEquals(max,partOut.getMAX_INV());
    }
    @Test
    void setMax() {
        int max=10;
